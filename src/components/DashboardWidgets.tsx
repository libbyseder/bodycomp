        ...
        {weightGoal && (
          <div>
            ...
            <div className="h-2 bg-zinc-800 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-emerald-500 to-emerald-400 rounded-full" style={{ width: `${weightProgress}%` }} />
            </div>
          </div>
        )}
      </div>
      ...
      <div className="bg-zinc-900 border border-zinc-700 rounded-3xl p-6">
        ...
        {bfGoal && (
          <div>
            ...
            <div className="h-2 bg-zinc-800 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-orange-500 to-yellow-400 rounded-full" style={{ width: `${bfProgress}%` }} />
            </div>
          </div>
        )}
      </div>
      ...
      <div className="bg-zinc-900 border border-zinc-700 rounded-3xl p-6">
        ...
        {ffmiGoal && currentFfmi && (
          <div>
            ...
            <div className="h-2 bg-zinc-800 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-blue-500 to-cyan-400 rounded-full" style={{ width: `${ffmiProgress}%` }} />
            </div>
          </div>
        )}
      </div>
